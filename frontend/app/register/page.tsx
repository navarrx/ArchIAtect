      ...
      <div className="container mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-6xl relative z-10">
        ...
        <div className="space-y-6 fade-in-up">
          ...
          <p className="text-muted-foreground max-w-xl">
            Diseña layouts, itera con IA y guarda tus planos en tu biblioteca personal. Ideal para la exploración y validación rápida de conceptos arquitectónicos.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="flex items-start gap-3 p-4 rounded-2xl border border-border/50 arch-shadow">
              ...
              <div>
                <p className="font-semibold">Iteraciones rápidas</p>
                <p className="text-sm text-muted-foreground">Genera alternativas de distribución en segundos.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-4 rounded-2xl border border-border/50 arch-shadow">
              <div className="mt-1">
              ...
              <div>
                <p className="font-semibold">Biblioteca de planos</p>
                <p className="text-sm text-muted-foreground">Organiza y descarga tus diseños cuando quieras.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-4 rounded-2xl border border-border/50 arch-shadow">
              <div className="mt-1">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Seguridad y recuperación de cuenta integradas.</p>
              </div>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <Button asChild className="rounded-xl">
              <Link href="/generator">Probar generador</Link>
            </Button>
          </div>
        </div>
